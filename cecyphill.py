...
<head>
    ...
    <style>
        ...
        header h1 {
            ...
            font-size: 2.6rem;
            text-align: center;
            animation: aparecerZoom 2s ease-out forwards; /* ANIMACIÓN */
        }
        ...
        .imagenes img {
            ...
            animation: flotar 3s ease-in-out infinite; /* ANIMACIÓN */
        }
...
<body>
    ...
    <section id="fichas técnicas">
        <h2>Fichas técnicas</h2>
        <div class="imagenes">
            <img src="codigo_malva.jpeg" alt="ficha_malva">
            <img src="codigo_nopal.jpeg" alt="ficha_menta">
            <img src="codigo_menta.jpeg" alt="ficha_nopal">
        </div>
    </section>

    <section id="Síguenos" class="contacto-box">
        <h2>Síguenos</h2>
        <p>Si deseas más información, ¡sígenos en nuestra pagina de instagram!</p>
